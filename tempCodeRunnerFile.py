...
if __name__ == "__main__":
    ...
    while True:
        ...
        #     os.startfile(path)
            ...
            speak("Hi there I am Pixie, I am a voice assistance based on ai. I am stil under development so i can't do every thing. If i cant so a certain task I will let you know.")
        
        elif 'abpout your creator' in query:
            speak('Hey Pixie here, I am made by Aritra Sanyal and Ankan Biswas fresher of University of Engineering & Management, Jaipur . I was made by ')
